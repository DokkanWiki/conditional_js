...
export enum StatementType {
    define, if, else, elif, ifdef, ifndef, elifdef, elifndef, endif
}

export const STATEMENT_TEST_TYPES = [StatementType.ifdef, StatementType.ifndef, StatementType.elifdef, StatementType.elifndef];
export const STATEMENT_TEST_NEGATE_TYPES = [StatementType.ifndef, StatementType.elifndef];
